...
public class DataFaker {
    ...
    public String getRandomSubject(){
        return faker.options().option("Biology", "English", "Physics", "Maths");
    }
    ...
    public String getRandomMonth(){
        return faker.options().option("February", "March", "April", "May", "June", "July",
    ...
    public String getRandomPhoto(){
        return faker.options().option("img.jpg", "messi.jpg");
    }
}
